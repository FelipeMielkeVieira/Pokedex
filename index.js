...
function filtrar() {
    ...
    let valorFiltro = document.querySelector('.inputfiltro').value;

    const listaFiltrada = lista.filter(function(a) {

        return a.name.toLowerCase().indexOf(valorFiltro.toLowerCase()) > -1
    });
